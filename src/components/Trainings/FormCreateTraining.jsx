        ...
        <div className='create-form-container'>
            ...
            <form className='create-form' encType='multipart/form-data' onSubmit={handleSubmit}>
                ...
                <div className='input-create-container'>
                    ...
                    <Select isSearchable={ false } isMulti isClearable name='coaches' options={coachesOpt} onChange={setCoachesAssis} value={coachesAssis} placeholder="Entrenadores" required />
                </div>
                <div className='input-create-container'>
