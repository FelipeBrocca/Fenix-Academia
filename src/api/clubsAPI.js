...
export const getClubsRequest = async () => await axios.get(`${process.env.BASEURL}clubs-hockey`)

export const clubDetailRequest = async (id) => await axios.get(`${process.env.BASEURL}clubs-hockey/${id}`)

export const newClubRequest = async(club) => await axios.post(`${process.env.BASEURL}clubs-hockey`, club)

export const updateClubRequest = async(id, club) => await axios.put(`${process.env.BASEURL}clubs-hockey/${id}`, club)

export const deleteClubRequest = async (id) => await axios.delete(`${process.env.BASEURL}clubs-hockey/${id}`)
